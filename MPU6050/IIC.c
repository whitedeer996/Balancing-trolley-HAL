...
#define GPIO_PORT_IIC_SCL     GPIOC                       /* GPIO???*/
#define GPIO_PORT_IIC_SDA     GPIOB                       /* GPIO???*/
#define RCC_IIC_ENABLE    __HAL_RCC_GPIOB_CLK_ENABLE()       /* GPIO???±? */
#define IIC_SCL_PIN       GPIO_PIN_13                  /* á????SCL???μ?PIO */
#define IIC_SDA_PIN       GPIO_PIN_12                  /* á????SDA?????PIO */

/* 定义读写SCL和SDA的宏，已增加代码的可移植性和可阅读性 */
#if 1	/* 条件编译： 1 选择GPIO的库函数实现IO读写 */
#define IIC_SCL_1()  HAL_GPIO_WritePin(GPIO_PORT_IIC_SCL, IIC_SCL_PIN, GPIO_PIN_SET)		/* SCL = 1 */
#define IIC_SCL_0()  HAL_GPIO_WritePin(GPIO_PORT_IIC_SCL, IIC_SCL_PIN, GPIO_PIN_RESET)		/* SCL = 0 */

#define IIC_SDA_1()  HAL_GPIO_WritePin(GPIO_PORT_IIC_SDA, IIC_SDA_PIN, GPIO_PIN_SET)		/* SDA = 1 */
#define IIC_SDA_0()  HAL_GPIO_WritePin(GPIO_PORT_IIC_SDA, IIC_SDA_PIN, GPIO_PIN_RESET)		/* SDA = 0 */

#define IIC_SDA_READ()  HAL_GPIO_ReadPin(GPIO_PORT_IIC_SDA, IIC_SDA_PIN)	/* 读SDA口线状态 */
...
void IIC_GPIO_Init(void)
{
    ...
    HAL_GPIO_Init(GPIO_PORT_IIC_SDA, &GPIO_InitStructure);
	  HAL_GPIO_Init(GPIO_PORT_IIC_SCL, &GPIO_InitStructure);
